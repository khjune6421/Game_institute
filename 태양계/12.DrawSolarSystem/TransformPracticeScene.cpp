...
void TransformPracticeScene::SetUp(HWND hWnd)
{
	...
	BoxObject* sun = MakePlanet(m_BitmapPtr[0], Vec2(0.f, 0.f), 50.f);
	...
	BoxObject* earth = MakePlanet(m_BitmapPtr[1], Vec2(400.f, 0.f), 200.f, sun);
	...
	BoxObject* moon = MakePlanet(m_BitmapPtr[2], Vec2(200.f, 0.f), 200.f, earth);
	...
	BoxObject* mars = MakePlanet(m_BitmapPtr[3], Vec2(-500.f, 0.f), -150.f, sun);
	...
	BoxObject* deimos = MakePlanet(m_BitmapPtr[4], Vec2(200.f, 0.f), 300.f, mars);
