...
void TestMainApp::Render()
{
    ...
    (
        static_cast<float>(f[frameIndex].m_frame.m_x),
        static_cast<float>(f[frameIndex].m_frame.m_y),
        static_cast<float>(f[frameIndex].m_frame.m_x + f[frameIndex].m_frame.m_w),
        static_cast<float>(f[frameIndex].m_frame.m_y + f[frameIndex].m_frame.m_h)
	);
	int xOffset = 500;
	int yOffset = 500;
	...
	(
		xOffset, yOffset,
		xOffset + f[frameIndex].m_frame.m_w, yOffset + f[frameIndex].m_frame.m_h
	);
